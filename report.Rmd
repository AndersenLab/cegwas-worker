...
library(readr)
library(compiler)
library("highr", lib.loc="~/Library/R/3.2/library")

# Get Payload
if (length(commandArgs(trailingOnly=TRUE)) == 0) {
  args <- fromJSON('{"submission_date": "2016-03-06T14:13:35.335770-06:00", "trait_name": "CAA", "success": true, "trait_slug": "caa", "report_hash": "4119505f81cbd75f5a66", "report_name": "Codon Usage2", "version": 1, "release": 0, "report_slug": "codon-usage2", "email": "danielecook@gmail.com"}')
} else {
