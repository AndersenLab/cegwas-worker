...
if (length(commandArgs(trailingOnly=TRUE)) == 0) {
  args <- fromJSON('{"release": 0, "report_slug": "telseq-full", "email": "danielcook2013@u.northwestern.edu", "version": 0.1, "report_name": "telomere-length", "trait_slug": "telomere-length"}')
} else {
